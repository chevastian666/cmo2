...
describe('PrecintosService', () => {
  ...
  describe('getPrecintos', () => {
    it('fetches precintos successfully', async () => {
      ...
      expect(Array.isArray(result.data)).toBe(_true)
  ...
  describe('getPrecinto', () => {
    ...
    it('handles not found error', async () => {
      server.use(http.get(`${_API_URL}/precintos/:id`, () => {
          return HttpResponse.json(
  ...
  describe('createPrecinto', () => {
    ...
    it('handles validation errors', async () => {
      ...
      await expect(precintosService.createPrecinto(_invalidPrecinto)).rejects.toThrow()
    })
  })
  describe('updatePrecinto', () => {
    it('updates precinto successfully', async () => {
      server.use(http.patch(`${_API_URL}/precintos/:id`, async ({ params, request }) => {
  ...
  describe('activatePrecinto', () => {
    it('activates precinto successfully', async () => {
      server.use(http.post(`${_API_URL}/precintos/:id/activar`, ({ params }) => {
          return HttpResponse.json({
            data: {
              id: params.id,
              estado: 'activo',
  ...
  describe('getPrecintoHistory', () => {
    it('fetches precinto history', async () => {
      server.use(http.get(`${_API_URL}/precintos/:id/historial`, () => {
          return HttpResponse.json({
            data: [
              {
  ...
  describe('exportPrecintos', () => {
    it('exports precintos to CSV', async () => {
      ...
      expect(_blob).toBeInstanceOf(_Blob)
    })
